...
export const GPUTextWebGL = {
  ...
  createTextProgram: function(
    gl,
    options,
    vertexCodeOverride,
    fragmentCodeOverride
  ) {
    ...
    let vs = createShader(
      gl,
      vertexCodeOverride || msdfShaders.vertexCode,
      gl.VERTEX_SHADER
    );
    let fs = createShader(
      gl,
      fragmentCodeOverride || msdfShaders.fragmentCode,
      gl.FRAGMENT_SHADER
    );
    ...
    return {
      ...
      uniformLocations: {
        ...
        glyphAtlas: gl.getUniformLocation(
          p,
          msdfShaders.uniform.glyphAtlas.name
        ),
        fieldRange: gl.getUniformLocation(
          p,
          msdfShaders.uniform.fieldRange.name
        ),
        resolution: gl.getUniformLocation(
          p,
          msdfShaders.uniform.resolution.name
        )
      }
    };
  },
