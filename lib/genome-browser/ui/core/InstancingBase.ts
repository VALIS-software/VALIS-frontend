 ...
 * - getFragmentCode()
 */
export class InstancingBase<Instance> extends Object2D {
    ...
    protected getVertexCode(): string { return ''; }
    protected getFragmentCode(): string { return ''; }

}

export default InstancingBase;