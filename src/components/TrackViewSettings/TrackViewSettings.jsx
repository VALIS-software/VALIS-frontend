...
class TrackViewSettings extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentWillReceiveProps(nextProps) {
    if (!nextProps.model || !nextProps.guid) {
      return;
    }
  ...
  render() {
        ...
        <div>
          <div className="vertical-wrapper">
            <RadioButtonGroup name="shipSpeed" defaultSelected="not_light">
              <RadioButton value="light" label="Scale to total track range" />
              <RadioButton
                value="not_light"
    ...
    return (
      <div className="track-view-settings">
        <Card>
          <CardHeader style={headerStyle} title="Track Color" />
          <CardText>{huePicker}</CardText>
        </Card>
        <Card>
