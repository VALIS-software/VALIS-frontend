...
import { CHROMOSOME_START_BASE_PAIRS, GENOME_LENGTH } from '../../helpers/constants.js';
...
class XAxis extends React.Component {
  ...
  render() {
    ...
    if ((endBasePair - windowState.startBasePair) > SHOW_CHROMOSOMES_THRESHOLD) {
      ...
      const outOfBounds = (endBasePair < 0) || (windowState.startBasePair > GENOME_LENGTH);
      const centerChromosome = outOfBounds ? null : Util.chromosomeIndex(centerBasePair);

      if (centerChromosome != null) {
        indicatorText = 'chromosome ' + Util.chromosomeIndexToName(centerChromosome);
      }
    }
