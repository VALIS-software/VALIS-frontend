...
function buildEncodeQueryParser(suggestions) {
    ...
    expansions.set('EQTL_QUERY_TYPE', [ANY, 'INFLUENCING_GENE', 'NAMED_SNP_RS', 'WITHIN_QUERY']);
    ...
    expansions.set('ENHANCER_QUERY', [ALL, 'ENHANCER', 'IN', 'CELL_TYPE', 'OPTIONAL_WITHIN']);
    expansions.set('PROMOTER_QUERY', [ALL, 'PROMOTER', 'IN', 'CELL_TYPE', 'OPTIONAL_WITHIN']);
